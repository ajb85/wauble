...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create waublee-8e82
  fly apps create waublee-8e82-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app waublee-8e82
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app waublee-8e82-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'waublee-8e82-staging' does not match app name in config file 'waublee-8e82'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name waublee-8e82-db
  fly postgres attach --app waublee-8e82 waublee-8e82-db

  fly postgres create --name waublee-8e82-staging-db
  fly postgres attach --app waublee-8e82-staging waublee-8e82-staging-db
  ```
